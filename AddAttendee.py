...
attendeeList = "attendees.txt"

# Your Current Event's Information
eventID = "853564864487" # Open your event then see the URL to obtain the ID, eg https://www.eventbrite.com/myevent?eid=123456
ticketID = "quant_1441816889" # Use the Dev Tools inspector to determine the ID of the ticket type you wish to add (https://i.imgur.com/isWfSJe.png)
